...
describe('should support Switch', function() {
  ...
  var prefixArr2 = [564182, 633110];
  for (var i = 0; i < prefixArr2.length; i++) {
    var prefix = prefixArr2[i];
    (function(prefix) {
      it('has a prefix of ' + prefix + ' and a length of 16', function() {
...
describe('should support China UnionPay', function() {
  ...
  for (var prefix = 622126; prefix <= 622925; prefix++) { 
    (function(prefix) {
      it('has a prefix of ' + prefix + ' and a length of 16', function() {
        detectNetwork(String(prefix) + '1234567890').should.equal('China UnionPay');
      }); 
      it('has a prefix of ' + prefix + ' and a length of 17', function() {
        detectNetwork(String(prefix) + '12345678901').should.equal('China UnionPay'); 
      }); 
      it('has a prefix of ' + prefix + ' and a length of 18', function() {
        detectNetwork(String(prefix) + '123456789012').should.equal('China UnionPay'); 
      }); 
      it('has a prefix of ' + prefix + ' and a length of 19', function() {
        detectNetwork(String(prefix) + '1234567890123').should.equal('China UnionPay'); 
      }); 
    })(prefix) 
  };
  ...
  for (var prefix = 6282; prefix <= 6288; prefix++) { 
    (function(prefix) {
      ...
      it('has a prefix of ' + prefix + ' and a length of 18', function() {
        detectNetwork(String(prefix) + '12345678901234').should.equal('China UnionPay'); 
      }); 
      it('has a prefix of ' + prefix + ' and a length of 19', function() {
        detectNetwork(String(prefix) + '123456789012345').should.equal('China UnionPay'); 
      }); 
    })(prefix) 
  };
  ...
  for (var prefix = 624; prefix <= 626; prefix++) { 
    (function(prefix) {
      ...
      it('has a prefix of ' + prefix + ' and a length of 19', function() {
        detectNetwork(String(prefix) + '1234567890123456').should.equal('China UnionPay'); 
      }); 
    })(prefix);
  };
});
