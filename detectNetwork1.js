...
// Switch always has a prefix of 4903, 4905, 4911, 4936, 564182, 633110, 6333, or 6759 and a length of 16, 18, or 19.
  if (cardNumber.slice(0, 4) == 4903 || cardNumber.slice(0, 4) == 4903 || cardNumber.slice(0, 4) == 4911 || cardNumber.slice(0, 4) == 4936 || cardNumber.slice(0, 4) == 6333 || cardNumber.slice(0, 4) == 6759 || cardNumber.slice(0, 6) == 564182 || cardNumber.slice(0, 6) == 633110) {
    if (cardNumber.length === 16 || cardNumber.length === 18 || cardNumber.length === 19) {
      return "Switch";
    }
  }
